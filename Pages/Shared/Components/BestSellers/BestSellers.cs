    ...
    public class BestSellers : ViewComponent
    {
        public IViewComponentResult Invoke()
        {
            var allProducts = new List<Product>
            {
               ...
               new Product { Id = 2, Name = "Samsung", Price = 20000000, Description = "Samsung ABC", SoldQuantity = 50}, // Ế nhất
               new Product { Id = 3, Name = "Oppo", Price = 5000000, Description = "Oppo ABC", SoldQuantity = 300}, // Bán chạy nhất
